          ...
          <div class="panel-body">
            <div class="form-wrap">
              ...
              <div class="form-group ">
                ...
                <input type="text" class="form-control" id="email_de" value="{{$user->email}}" name="email">
              </div>
              <div class="form-group">
              ...
              <div>
                <img src="{{$user->getAvatar()}}" alt="image" class="img-circle" width="100">
              </div>
              <div class="form-group mb-30">
                ...
                <div class="form-group ">
                  <a href="{{route('users.index')}}" type="button" class="btn btn-default btn-anim pull-left"><i class="fas fa-arrow-left pt-10"></i><span class="btn-text">Назад</span></a>
