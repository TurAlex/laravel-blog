...
@section('content')
  ...
  <div class="row heading-bg">
    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
      <h5 class="txt-dark">Изменить коментарий</h5>
    </div>
    <!-- Breadcrumb -->
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
      <ol class="breadcrumb">
        ...
        <li class="active"><span>Изменить коментарий</span></li>
      </ol>
    </div>
    <!-- /Breadcrumb -->
  </div>
    ...
    <div class="col-sm-12">
      <div class="panel panel-default card-view">
        <div class="panel-heading">
          <div class="pull-left">
            <h6 class="panel-title txt-dark">Изменение коментарий</h6>
          ...
          <div class="panel-body">
            <div class="form-wrap">
              ...
              <div class="form-group col-sm-6">
                ...
                <input type="text" class="form-control" value="{{$comment->author_id}}" name="author_id">
              </div>
              <div class="form-group col-sm-6">
                <label class="control-label mb-10 text-left">Пост</label>
                <input type="text" class="form-control" value="{{$comment->post_id}}" name="post_id">
              </div>
