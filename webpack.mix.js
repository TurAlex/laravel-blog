...
mix.styles([
    ...
    'resources/assets/admin/vendors/bower_components/jasny-bootstrap/dist/css/jasny-bootstrap.min.css',
    'resources/assets/admin/dist/css/fontawesome-all.css',
    ...
    'resources/assets/admin/vendors/bower_components/eonasdan-bootstrap-datetimepicker/build/css/bootstrap-datetimepicker.min.css',
    'resources/assets/admin/vendors/bower_components/select2/dist/css/select2.min.css',
    'resources/assets/admin/vendors/bower_components/switchery/dist/switchery.min.css',
...
mix.scripts([
    ...
    'resources/assets/admin/vendors/bower_components/bootstrap-select/dist/js/bootstrap-select.min.js',
    'resources/assets/admin/vendors/bower_components/switchery/dist/switchery.min.js',
    'resources/assets/admin/dist/js/tinymce-data.js',
    ...
    'resources/assets/admin/vendors/bower_components/switchery/dist/switchery.min.js',
    'resources/assets/admin/vendors/bower_components/moment/min/moment-with-locales.min.js',
    'resources/assets/admin/vendors/bower_components/eonasdan-bootstrap-datetimepicker/build/js/bootstrap-datetimepicker.min.js',
